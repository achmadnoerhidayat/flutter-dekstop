...
class ModalSetorKasbon extends StatefulWidget {
  final List<Map<String, dynamic>>? keterangan;
  const ModalSetorKasbon({super.key, required this.keterangan});

  @override
  State<ModalSetorKasbon> createState() => _ModalSetorKasbonState();
}

class _ModalSetorKasbonState extends State<ModalSetorKasbon> {
  ...
  void initState() {
    ...
    var gula = widget.keterangan!.firstWhere(
      (value) => value['title'] == "Setor Kasbon",
      orElse: () => {},
    );
    if (gula.isNotEmpty) {
