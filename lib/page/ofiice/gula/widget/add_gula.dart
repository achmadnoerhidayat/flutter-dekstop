...
class AddGula extends StatefulWidget {
  const AddGula({super.key});

  @override
  State<AddGula> createState() => _AddGulaState();
}

class _AddGulaState extends State<AddGula> {
