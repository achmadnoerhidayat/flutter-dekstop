...
class FormDebtWatch extends StatefulWidget {
  final DebtWatchModel? watchModel;
  const FormDebtWatch({super.key, this.watchModel});

  @override
  State<FormDebtWatch> createState() => _FormDebtWatchState();
}

class _FormDebtWatchState extends State<FormDebtWatch> {
  ...
  void initState() {
    ...
    if (widget.watchModel != null) {
      txtUser!.text = widget.watchModel!.idCustomer!;
      txtNominal!.text =
          NumberFormats.convertToIdr(widget.watchModel!.nominal!);
    }
  }
                        ...
                        onPressed: () {
                          if (formState.currentState!.validate()) {
                            if (widget.watchModel != null) {
                              ...
                              context
                                  .read<DebWatchBloc>()
                                  .add(UpdateDebtWatch(debtWatchModel: req));
                            } else {
                              ...
                              context
                                  .read<DebWatchBloc>()
                                  .add(CreateDebtWatch(debtWatchModel: req));
                            }
