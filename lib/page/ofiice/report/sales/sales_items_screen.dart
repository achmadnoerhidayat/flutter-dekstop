...
class SalesItemsScreen extends StatefulWidget {
  static String routeName = '/ofice/report/sales-items';
  const SalesItemsScreen({super.key});

  @override
  State<SalesItemsScreen> createState() => _SalesItemsScreenState();
}

class _SalesItemsScreenState extends State<SalesItemsScreen> {
  ...
  void initState() {
    ...
    context.read<TransaksiBloc>().add(GetTransaksiDetailSales(params: request));
          ...
          return SizedBox(
            ...
            child: PlutoGrid(
              ...
              rows: state.transaksiDetail.map((detail) {
                ...
                return PlutoRow(
                  cells: {
                    'name': PlutoCell(value: detail.product!.namaBarang),
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  context.read<TransaksiBloc>().add(
                                      GetTransaksiDetailSales(params: request));
                                },
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: const SidebarSales(type: 'items'),
                                ),
                                transaksi,
                              ],
                            ),
