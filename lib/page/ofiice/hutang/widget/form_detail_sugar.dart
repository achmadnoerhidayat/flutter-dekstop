...
class FormDetailSugar extends StatefulWidget {
  final DebtSugarModel? debtSugarModel;
  const FormDetailSugar({super.key, this.debtSugarModel});

  @override
  State<FormDetailSugar> createState() => _FormDetailSugarState();
}

class _FormDetailSugarState extends State<FormDetailSugar> {
                        ...
                        onPressed: () {
                          if (formState.currentState!.validate()) {
                            ...
                            debtDetail.add(DebtSugarDetailModel(
                              idHutang: widget.debtSugarModel!.id.toString(),
                              type: txtType!.text,
                            ...
                            context.read<DebtSugarBloc>().add(
                                CreateDebtSugarDetail(debtSugarModel: req));
